...
ChokeAdvisor::ChokeAdvisor(void)
{
}
...
void ChokeAdvisor::update()
{
}

void ChokeAdvisor::addBase(BWTA::BaseLocation* base)
{
...
void ChokeAdvisor::removeBase(BWTA::BaseLocation* base)
{
	for(std::set<BWTA::BaseLocation*>::iterator i=enemyBases.begin();i!=enemyBases.end();i++) {
...
int ChokeAdvisor::pollChoke(BWTA::Chokepoint* choke)
{
	return quickPoll(choke);
}

std::set<BWTA::Chokepoint*> ChokeAdvisor::contestedChokes()
{
...
std::set<BWTA::Chokepoint*> ChokeAdvisor::heldChokes()
{
	std::set<BWTA::Chokepoint*> allChokes = BWTA::getChokepoints();
	std::set<BWTA::Chokepoint*> ret;
	for(std::set<BWTA::Chokepoint*>::iterator i=allChokes.begin();i!=allChokes.end();i++) {
...
std::set<BWTA::Chokepoint*> ChokeAdvisor::controlledChokes()
{
	std::set<BWTA::Chokepoint*> allChokes = BWTA::getChokepoints();
	std::set<BWTA::Chokepoint*> ret;
	for(std::set<BWTA::Chokepoint*>::iterator i=allChokes.begin();i!=allChokes.end();i++) {
...
BWTA::Chokepoint* ChokeAdvisor::priorityChoke()
{
...
int ChokeAdvisor::quickPoll(BWTA::Chokepoint* choke)
{
...
int ChokeAdvisor::chokeData(BWTA::Chokepoint* choke)
{
...
double ChokeAdvisor::distToEnemy(BWTA::Chokepoint* choke)
{
	double dist = -1;
